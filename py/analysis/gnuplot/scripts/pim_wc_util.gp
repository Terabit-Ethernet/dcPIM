...
set yrange [0:1]
#set ytics 0, 1, 0.1
set output "img/pim_worstcase_util.eps"

plot "data/pim_all_min.txt" using 1:2 with lp ls 1 title "PIM FCT",\
 "data/worst_case_pim_1_util.txt" using 1:2 with lp ls 2 title "PIM 1FCT"
# set terminal xterm
# replot
