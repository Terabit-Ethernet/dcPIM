...
set style line 5 lt rgb "#006666" lw 2 pt 4
...
set output "img/".ARG1."_bandwidth_slowdown.eps"


plot "data/".ARG1."_bandwidth_slowdown.dat" using 1:2 with lp ls 1 title 'pFabric',\
