...
set output 'img/'.ARG1.'_'.ARG2.'_'.ARG3.'_'.ARG4.'_slowdown_flow_size.eps'

plot 'data/'.ARG1.'_'.ARG2.'_'.ARG3.''_'.ARG4.'_slowdown_size.dat' using 2:3:xtic(1) title 'Homa Aeolus' fillstyle pattern 5 lc rgb "#FF8000",\
        '' using 4:5 title 'NDP' fillstyle pattern 7 transparent lc rgb "#FF3333",\
	'' using 6:7 title 'HPCC' fillstyle pattern 4 transparent lc rgb "#5060D0", \
	'' using 8:9 title 'dcPIM' fillstyle pattern 6 transparent lc rgb "#009900"
