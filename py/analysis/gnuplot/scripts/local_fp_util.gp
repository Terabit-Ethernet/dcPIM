...
set output "img/".ARG1."_fp_local_traffic_util.eps"

plot "data/".ARG1."_fp_local_traffic_2_util.dat" using 1:2 with lp ls 8 title 'Fastpass',\
   '' using 1:3 with lp ls 6 title 'Fastpass Opt'
