...
def main():
    date = str(sys.argv[1])
    util, fct_oct_ratio =  read_outputs("../../result/all-to-all/" + date)
    # draw_graph(util, trace + " Utilization")
    # draw_graph(fct_oct_ratio, trace + " Slowdown")
    print util, fct_oct_ratio
    output_file(util, "../gnuplot/data/constant_util.dat")
    output_file(fct_oct_ratio, "../gnuplot/data/constant_slowdown.dat")
