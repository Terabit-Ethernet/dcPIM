...
def main():
    ...
    util, fct_oct_ratio, stats =  read_outputs("../../../data/load/" + date, trace)
    ...
    output_file(util, "../gnuplot/data/{}_load_util.dat".format(trace))
    output_file(fct_oct_ratio, "../gnuplot/data/{}_load_slowdown.dat".format(trace))
main()
