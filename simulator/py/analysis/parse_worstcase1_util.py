...
def read_file(filename):
    ...
    with open(filename) as f:
        ...
        for i in range(len(lines) - 1):
            line = lines[i]
            params = line.split()
            output.append([params[0], float(params[1]) / 1600,])
    return output
...
def main():
    output =  read_file("../result/worst_case/pim_util_worstcase1.txt" )
    ...
    output_file(output, "../result/worst_case/pim_util_worstcase1_result.txt", "<TIME> <UTILIZATION>\n")
