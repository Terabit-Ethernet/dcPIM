...
set output 'img/'.ARG1.'_'.ARG2.'_ruf_slowdown_flow_size.eps'

plot 'data/'.ARG1.'_'.ARG2.'_ruf_slowdown_size.dat' using 2:3:xtic(1) title 'Pri=off, RestrictCon=off' fillstyle pattern 1, \
	'' using 4:5 title 'Pri=off, RestrictCon=on' fillstyle pattern 5 transparent lc rgb "#FF8000", \
	'' using 6:7 title 'Pri=on, RestrictCon=off' fillstyle pattern 4, \
        '' using 8:9 title 'Pri=on, RestrictCon=on' fillstyle pattern 7 transparent lc rgb "#00A000", \
#        '' using 14:15 title 'DCTCP' fillstyle pattern 6 transparent lc rgb "#808080", \
#	'' using 12:13 title 'dcPIM' fillstyle pattern 2 transparent lc rgb "#00A000"
