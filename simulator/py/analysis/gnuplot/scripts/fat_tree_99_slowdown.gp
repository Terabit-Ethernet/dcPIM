...
set output "img/fat_tree_99_slowdown.eps"

plot "data/fat_tree_99_slowdown.dat" using 2:xtic(1) title 'Homa Aeolus' fillstyle pattern 5 transparent lc rgb "#FF8000",\
