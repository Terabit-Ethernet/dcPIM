...
set xlabel 'Load'
set ylabel 'Max Queue Occupancy(KB)'
...
set yrange [0:9000]
#set logscale y 5
#set ytics (30, 150, 750, 2250)
set output "img/".ARG1."_load_max_switch_size.eps"


plot "data/".ARG1."_load_max_switch_size.dat" using 1:2 with lp ls 1 title 'dcPIM 3 round',\
