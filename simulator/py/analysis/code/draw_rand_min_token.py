...
def main():
    date = str(sys.argv[1])
    util, fct_oct_ratio, stats =  read_outputs("../../result/rand_min_token/" + date)
    ...
    print util
    print fct_oct_ratio
    output_file(util, "../gnuplot/data/rand_min_token_util.dat")
    output_file(fct_oct_ratio, "../gnuplot/data/rand_min_token_slowdown.dat")
main()
