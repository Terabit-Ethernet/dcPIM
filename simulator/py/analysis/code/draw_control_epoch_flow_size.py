...
def main():
    ...
    stats, num_elements =  read_outputs("../../result/control_epoch/" + date, workload)
    # draw_graph(average, "FCT_OCT_Ratio" + "_" + workload + "_" + alg)
    # draw_graph(stats, num_elements, workload + " FCT_OCT_ratio")
    print stats
    output_file(stats, "../gnuplot/data/{0}_control_epoch_slowdown_size.dat".format(workload))
main()
