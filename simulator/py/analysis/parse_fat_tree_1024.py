...
def main():
    ...
    util, fct_oct_ratio, fct_oct_ratio_99 =  read_outputs("../result/fat_tree_1024/" + date)
    ...
    output_file(fct_oct_ratio, "../result/fat_tree_1024/fat_tree_slowdown.dat", "<WORKLOAD> <SLOWDOWN>\n")
